...
class Application_Interface:
    ...
    def run(self):
        ...
        self.userlogin=Button(self.window,text="Login as User",command=self.check_user,padx=20, pady=5, fg="white",bg="#B33030", font=('calibre', 10, 'bold'),activebackground="#B33030",activeforeground="white")
    ...
    def Admin_Page(self):
        ...
        usere=Entry(root,width=40)
        passe=Entry(root,width=40)
        ...
        insert_button=Button(root,text="Insert",width=20, padx=7, pady=5, bg="#B33030", fg="white", font=('calibre', 10, 'bold'))
        Delete_button=Button(root,text="Delete",width=20, padx=7, pady=5, bg="#B33030", fg="white", font=('calibre', 10, 'bold'))
        ...
        usere.place(x=330,y=280)
        passe.place(x=330,y=360)
        line.place(x=0,y=420)
        Delete_user.place(x=330,y=480)
